"""the pre-release stage layout QC v4 (read-only, plotting-only).
...
def main():
    for fn in ["fig1.py", "fig2.py", "fig3.py", "fig4.py", "fig5.py", "fig6.py", "figS.py"]:
    ...
    out = os.path.join(QC_DIR, "layout_qc_figures.txt")
    txt = "\n".join(REPORT)
